...
Python ist in der Lage auch ohne eine Schleife eine Liste in die Konsole auszugeben.  Der Code \code{print(gegenstaende)} reicht um jedes Element einer Liste zu schreiben.\cite{Python3:Buch}\cite{Louis:2010}
\par
